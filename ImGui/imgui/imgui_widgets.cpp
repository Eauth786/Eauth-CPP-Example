...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    window->DrawList->AddRectFilled(newRect.Min, newRect.Max, ImColor(31, 31, 30), 10);
    ...
    if (*v) {
        ...
        //reset canvas
        window->DrawList->AddRectFilled(ImVec2(newRect.Min.x - 1.f, newRect.Min.y - 1.f), ImVec2(newRect.Max.x + .5f, newRect.Max.y + 1.f), GetColorU32(ImGuiCol_CheckMark), 10);
